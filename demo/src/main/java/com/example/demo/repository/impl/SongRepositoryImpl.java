...
//        DataHolder.songs.stream().filter(x->x.getTrackId().equals(song.getTrackId())).findFirst().ifPresent(x->{x.getArtists().add(artist);});
//    }
//
...
//        }
//    }
//    public List<Song> getFromGenre(String genre){
//        return DataHolder.songs.stream().filter(x->x.getGenre().equals(genre)).collect(Collectors.toList());
//    }
//}
